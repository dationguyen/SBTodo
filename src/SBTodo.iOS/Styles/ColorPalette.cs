...
namespace SBTodo.iOS.Styles
{
    public static class ColorPalette
    {
        public static UIColor Primary => FromHexString("#29274C");
        public static UIColor PrimaryDark => FromHexString("#012A36");
        public static UIColor PrimaryLight => FromHexString("#7E52A0");
        ...
        public static UIColor PrimaryText => UIColor.White;
        public static UIColor SecondaryText => FromHexString("#D295BF");
